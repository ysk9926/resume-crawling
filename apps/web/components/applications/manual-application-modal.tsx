...
import { createManualApplicationAction } from "@/app/actions";
import {
  inputStyle,
  primaryButtonStyle,
...
type ManualApplicationModalProps = {
...
export function ManualApplicationModal({
  ...
  function handleSubmit(formData: FormData) {
    startTransition(() => {
      void createManualApplicationAction(formData);
    });
  }
  ...
  return (
    <>
      ...
      <dialog
        ...
        aria-labelledby="manual-application-modal-title"
      >
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          >
            <div style={{ minWidth: 0 }}>
              <h2
                id="manual-application-modal-title"
                style={{
                  margin: 0,
                  fontSize: 16,
                  fontWeight: 700,
              ...
              >
                리멤버처럼 크롤링되지 않는 플랫폼의 지원 이력을 직접 생성합니다. 새 플랫폼명은
                저장 즉시 DB에 등록됩니다.
              </p>
            </div>
            <button
          ...
          {resumes.length === 0 ? (
            ...
            >
              수동 지원도 이력서 템플릿이 필요합니다. 먼저 이력서 페이지에서 템플릿을 만들어
              주세요.
            </div>
          ) : (
            <form
                ...
                >
                  ...
                  <label style={formLabelStyle}>
                    ...
                    <textarea
                      ...
                      rows={4}
                      placeholder="공고 요약, 자격요건, 링크 외 텍스트"
                      style={textareaStyle}
                    />
                  </label>
                  <label style={formLabelStyle}>
